...
const TourCategory = ({ icon, title, count }) => {
  return (
    <div className="flex flex-col items-center bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:-translate-y-1">
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="relative">
                ...
                <select className="pl-3 pr-10 py-2 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none">
              ...
              <button className="bg-blue-600 text-white font-medium px-4 py-2 rounded-md hover:bg-blue-700 transition-colors duration-200 flex items-center justify-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <TestimonialCard 
              name="Michael Chen"
              location="Singapore"
              text="We took the Japan Cherry Blossom tour and it exceeded all our expectations. The timing was perfect and we saw the blossoms at their peak. The small group size made it a personal experience. Highly recommended!"
            ...
            <TestimonialCard 
              ...
              text="The Kerala Backwaters tour was the most relaxing vacation I've ever had. The houseboat experience was unique and the food prepared on board was delicious. I loved the tranquility of the backwaters and the beautiful scenery."
